...
const VinylsGraphic = ({ styling }: Props) => {
  return (
    <div className={`relative w-[250px] h-[210px] sm:w-[350px] sm:h-[325px] lg:w-[510px] lg:h-[450px] ${styling}`}>
      <svg viewBox="0 0 310 310" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[150px] h-[150px] sm:w-[225px] sm:h-[225px] lg:w-[310px] lg:h-[310px] text-blue-brand-500 absolute bottom-0 right-0">
